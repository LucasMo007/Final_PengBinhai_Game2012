...
// Keyboard input
bool IsKeyDown(int key);		// If a key is held
...
// Mouse cursor modes
#define CURSOR_NORMAL    0x00034001  // GLFW_CURSOR_NORMAL
#define CURSOR_HIDDEN    0x00034002  // GLFW_CURSOR_HIDDEN
#define CURSOR_DISABLED  0x00034003  // GLFW_CURSOR_DISABLED
